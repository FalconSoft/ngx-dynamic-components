...
/***/ "./node_modules/p-utils/dist/p-utils.esm.js":
/*!**************************************************!*\
  !*** ./node_modules/p-utils/dist/p-utils.esm.js ***!
  \**************************************************/
...
function getHeaders(headers) {
    if (headers && typeof headers === 'object') {
        var httpHeader_1 = new Headers();
        Object.entries(headers).forEach(function (_a) {
            var name = _a[0], value = _a[1];
            httpHeader_1.set(name, value);
        });
        return httpHeader_1;
    }
}//# sourceMappingURL=p-utils.esm.js.map
...
var HistoryComponent = /** @class */ (function () {
    ...
    HistoryComponent.prototype.onSelect = function (item) {
        ...
        if (item.hasOwnProperty('request')) {
            ...
            Object(_store_utils__WEBPACK_IMPORTED_MODULE_8__["updateStore"])(this.store, { scripts: item.scripts }, '/rest-client/pscript-editor');
        }
    };
...
/***/ "./src/app/rest-client/components/pscript-editor/pscript-editor.component.scss":
/*!*************************************************************************************!*\
  !*** ./src/app/rest-client/components/pscript-editor/pscript-editor.component.scss ***!
  \*************************************************************************************/
/*! no static exports found */
...
module.exports = "::ng-deep .workflow-logs-container.popover {\n  max-width: 400px;\n  width: 400px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/rest-client/components/pscript-editor/pscript-editor.component.ts":
/*!***********************************************************************************!*\
  !*** ./src/app/rest-client/components/pscript-editor/pscript-editor.component.ts ***!
  \***********************************************************************************/
/*! exports provided: PScriptEditorComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PScriptEditorComponent", function() { return PScriptEditorComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm5/store.js");
...
var PScriptEditorComponent = /** @class */ (function () {
    function PScriptEditorComponent(store, dialogService, authService, loginService, router) {
        this.store = store;
        this.dialogService = dialogService;
        this.authService = authService;
        this.loginService = loginService;
        ...
        this.newRequestLink = {
            ...
            folder: null,
            description: null,
            linkType: _models__WEBPACK_IMPORTED_MODULE_8__["LinkType"].PScriptEditor,
            id: 0
        };
    }
    PScriptEditorComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PScriptEditorComponent.prototype.ngOnDestroy = function () {
        this.destroy.next();
        this.destroy.complete();
    };
    PScriptEditorComponent.prototype.run = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    PScriptEditorComponent.prototype.save = function () {
        var _this = this;
        if (this.isAuthenticated) {
    ...
    PScriptEditorComponent.prototype.onDeleteRequest = function () {
        if (this.selectedSavedRequestLink) {
    ...
    PScriptEditorComponent.prototype.onNewPScriptEditor = function () {
        Object(_store_utils__WEBPACK_IMPORTED_MODULE_14__["updateStore"])(this.store);
        this.router.navigate(['/rest-client', 'pscript-editor']);
    };
    PScriptEditorComponent.prototype.onResize = function () {
        this.script.resize();
    ...
    PScriptEditorComponent.ctorParameters = function () { return [
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
    ...
    ], PScriptEditorComponent.prototype, "responseExplorer", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    ], PScriptEditorComponent.prototype, "script", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    ], PScriptEditorComponent.prototype, "showIn", void 0);
    PScriptEditorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-pscript-editor',
            template: __webpack_require__(/*! raw-loader!./pscript-editor.component.html */ "./node_modules/raw-loader/index.js!./src/app/rest-client/components/pscript-editor/pscript-editor.component.html"),
            styles: [__webpack_require__(/*! ./pscript-editor.component.scss */ "./src/app/rest-client/components/pscript-editor/pscript-editor.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"],
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], PScriptEditorComponent);
    return PScriptEditorComponent;
}());
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../models */ "./src/app/rest-client/models/index.ts");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm5/store.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../store */ "./src/app/rest-client/store/index.ts");
/* harmony import */ var _store_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../store/actions */ "./src/app/rest-client/store/actions/index.ts");
/* harmony import */ var src_app_shared_app_variables__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/app-variables */ "./src/app/shared/app-variables.ts");
...
var ResponseComponent = /** @class */ (function () {
    ...
    ResponseComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.response$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(_store__WEBPACK_IMPORTED_MODULE_4__["selectResponseModel"]));
        this.responseStatus$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(_store__WEBPACK_IMPORTED_MODULE_4__["selectResponseStatus"]));
        this.loading$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(_store__WEBPACK_IMPORTED_MODULE_4__["selectResponseLoading"]));
        ...
        this.uiSettings$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])((function (state) { return state.requestModel.requestContentModel.uiSettings; })));
    ...
    ResponseComponent.prototype.onTabsOptionsChanged = function (e) {
        ...
        this.store.dispatch(new _store_actions__WEBPACK_IMPORTED_MODULE_5__["UpdateUiSettings"](this.uiSettings));
    };
    ...
    ResponseComponent.prototype.setContentValue = function (responseModel) {
        var value = src_app_shared_app_variables__WEBPACK_IMPORTED_MODULE_6__["Variables"].resolveString('{{responseContent}}');
        if (!value || value === '{{responseContent}}') {
            this.dataModel = null;
            this.responseType = null;
        }
        else {
            if (responseModel.contentType === _models__WEBPACK_IMPORTED_MODULE_2__["ContentTypes"].JSON && typeof value === 'object') {
            ...
            if (ownerName && name_1) {
                ...
                switch (linkType) {
                    case _models__WEBPACK_IMPORTED_MODULE_5__["LinkType"].RestRequest:
                        ...
                        break;
                    case _models__WEBPACK_IMPORTED_MODULE_5__["LinkType"].PScriptEditor:
                        this.router.navigate(['pscript-editor', ownerName, name_1], { relativeTo: this.route });
                        break;
...
var SidebarComponent = /** @class */ (function () {
    ...
    SidebarComponent.prototype.onNewPScriptEditor = function () {
        Object(_store_utils__WEBPACK_IMPORTED_MODULE_7__["updateStore"])(this.store);
        this.router.navigate(['/rest-client', 'pscript-editor']);
    };
...
(function (LinkType) {
    ...
    LinkType["PScriptEditor"] = "MultiRequest";
...
/* harmony import */ var _components_pscript_editor_pscript_editor_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/pscript-editor/pscript-editor.component */ "./src/app/rest-client/components/pscript-editor/pscript-editor.component.ts");
...
var routes = [{
        ...
        children: [{
                ...
                path: 'pscript-editor',
                component: _components_pscript_editor_pscript_editor_component__WEBPACK_IMPORTED_MODULE_5__["PScriptEditorComponent"],
                children: [{
                        path: ':ownerName/:requestName'
                    }]
            }, {
...
/* harmony import */ var _ngx_dynamic_components_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ngx-dynamic-components/core */ "../ngx-dynamic-components/dist/@ngx-dynamic-components/core/fesm5/ngx-dynamic-components-core.js");
/* harmony import */ var _ngx_dynamic_components_bootstrap__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ngx-dynamic-components/bootstrap */ "../ngx-dynamic-components/dist/@ngx-dynamic-components/bootstrap/fesm5/ngx-dynamic-components-bootstrap.js");
/* harmony import */ var _ngx_dynamic_components_material__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ngx-dynamic-components/material */ "../ngx-dynamic-components/dist/@ngx-dynamic-components/material/fesm5/ngx-dynamic-components-material.js");
/* harmony import */ var src_app_shared__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/shared */ "./src/app/shared/index.ts");
/* harmony import */ var src_app_wijmo_wijmo_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/app/wijmo/wijmo.module */ "./src/app/wijmo/wijmo.module.ts");
/* harmony import */ var _rest_client_routing_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./rest-client-routing.module */ "./src/app/rest-client/rest-client-routing.module.ts");
/* harmony import */ var _components_rest_layout_rest_layout_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/rest-layout/rest-layout.component */ "./src/app/rest-client/components/rest-layout/rest-layout.component.ts");
/* harmony import */ var _components_rest_content_rest_content_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/rest-content/rest-content.component */ "./src/app/rest-client/components/rest-content/rest-content.component.ts");
/* harmony import */ var _components_request_request_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/request/request.component */ "./src/app/rest-client/components/request/request.component.ts");
/* harmony import */ var _components_response_response_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/response/response.component */ "./src/app/rest-client/components/response/response.component.ts");
/* harmony import */ var _components_dynamic_page_dynamic_page_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/dynamic-page/dynamic-page.component */ "./src/app/rest-client/components/dynamic-page/dynamic-page.component.ts");
/* harmony import */ var _components_sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/sidebar/sidebar.component */ "./src/app/rest-client/components/sidebar/sidebar.component.ts");
/* harmony import */ var _components_dynamic_workflow_dynamic_workflow_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/dynamic-workflow/dynamic-workflow.component */ "./src/app/rest-client/components/dynamic-workflow/dynamic-workflow.component.ts");
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./store */ "./src/app/rest-client/store/index.ts");
/* harmony import */ var _store_effects__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./store/effects */ "./src/app/rest-client/store/effects/index.ts");
/* harmony import */ var _services_requests_service__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./services/requests.service */ "./src/app/rest-client/services/requests.service.ts");
/* harmony import */ var _services_environment_service__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./services/environment.service */ "./src/app/rest-client/services/environment.service.ts");
/* harmony import */ var src_app_shared_services__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! src/app/shared/services */ "./src/app/shared/services/index.ts");
/* harmony import */ var _ngrx_store_devtools__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! @ngrx/store-devtools */ "./node_modules/@ngrx/store-devtools/fesm5/store-devtools.js");
/* harmony import */ var _ngrx_effects__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! @ngrx/effects */ "./node_modules/@ngrx/effects/fesm5/effects.js");
/* harmony import */ var _components_saved_requests_saved_requests_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./components/saved-requests/saved-requests.component */ "./src/app/rest-client/components/saved-requests/saved-requests.component.ts");
/* harmony import */ var _components_environments_environments_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./components/environments/environments.component */ "./src/app/rest-client/components/environments/environments.component.ts");
/* harmony import */ var _components_assertion_logs_assertion_logs_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./components/assertion-logs/assertion-logs.component */ "./src/app/rest-client/components/assertion-logs/assertion-logs.component.ts");
...
/* harmony import */ var _components_history_history_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./components/history/history.component */ "./src/app/rest-client/components/history/history.component.ts");
/* harmony import */ var _components_curl_form_curl_form_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./components/curl-form/curl-form.component */ "./src/app/rest-client/components/curl-form/curl-form.component.ts");
/* harmony import */ var _components_pscript_editor_pscript_editor_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./components/pscript-editor/pscript-editor.component */ "./src/app/rest-client/components/pscript-editor/pscript-editor.component.ts");
/* harmony import */ var _components_data_editor_data_editor_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./components/data-editor/data-editor.component */ "./src/app/rest-client/components/data-editor/data-editor.component.ts");
/* harmony import */ var _components_save_request_save_request_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./components/save-request/save-request.component */ "./src/app/rest-client/components/save-request/save-request.component.ts");
/* harmony import */ var _components_show_in_presenter_show_in_presenter_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./components/show-in-presenter/show-in-presenter.component */ "./src/app/rest-client/components/show-in-presenter/show-in-presenter.component.ts");
/* harmony import */ var _services_run_request_service__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./services/run-request.service */ "./src/app/rest-client/services/run-request.service.ts");
/* harmony import */ var _components_script_script_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./components/script/script.component */ "./src/app/rest-client/components/script/script.component.ts");
...
var RestClientModule = /** @class */ (function () {
    ...
    RestClientModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                _components_rest_layout_rest_layout_component__WEBPACK_IMPORTED_MODULE_17__["RestLayoutComponent"],
                _components_rest_content_rest_content_component__WEBPACK_IMPORTED_MODULE_18__["RestContentComponent"],
                _components_request_request_component__WEBPACK_IMPORTED_MODULE_19__["RequestComponent"],
                _components_response_response_component__WEBPACK_IMPORTED_MODULE_20__["ResponseComponent"],
                _components_dynamic_page_dynamic_page_component__WEBPACK_IMPORTED_MODULE_21__["DynamicPageComponent"],
                _components_sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_22__["SidebarComponent"],
                _components_dynamic_workflow_dynamic_workflow_component__WEBPACK_IMPORTED_MODULE_23__["DynamicWorkflowComponent"],
                _components_saved_requests_saved_requests_component__WEBPACK_IMPORTED_MODULE_32__["SavedRequestsComponent"],
                _components_environments_environments_component__WEBPACK_IMPORTED_MODULE_33__["EnvironmentsComponent"],
                _components_history_history_component__WEBPACK_IMPORTED_MODULE_36__["HistoryComponent"],
                _components_curl_form_curl_form_component__WEBPACK_IMPORTED_MODULE_37__["CurlFormComponent"],
                _components_pscript_editor_pscript_editor_component__WEBPACK_IMPORTED_MODULE_38__["PScriptEditorComponent"],
                _components_data_editor_data_editor_component__WEBPACK_IMPORTED_MODULE_39__["DataEditorComponent"],
                _components_save_request_save_request_component__WEBPACK_IMPORTED_MODULE_40__["SaveRequestComponent"],
                _components_assertion_logs_assertion_logs_component__WEBPACK_IMPORTED_MODULE_34__["AssertionLogsComponent"],
                _components_show_in_presenter_show_in_presenter_component__WEBPACK_IMPORTED_MODULE_41__["ShowInPresenterComponent"],
                _components_script_script_component__WEBPACK_IMPORTED_MODULE_43__["ScriptComponent"]
            ],
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _rest_client_routing_module__WEBPACK_IMPORTED_MODULE_16__["RestClientRoutingModule"],
                ...
                src_app_shared__WEBPACK_IMPORTED_MODULE_14__["SharedModule"],
                src_app_wijmo_wijmo_module__WEBPACK_IMPORTED_MODULE_15__["WijmoModule"],
                _ngx_dynamic_components_core__WEBPACK_IMPORTED_MODULE_11__["CoreModule"],
                _ngx_dynamic_components_bootstrap__WEBPACK_IMPORTED_MODULE_12__["BootstrapModule"],
                _ngx_dynamic_components_material__WEBPACK_IMPORTED_MODULE_13__["MaterialModule"],
                _ngrx_store__WEBPACK_IMPORTED_MODULE_24__["StoreModule"].forRoot(_store__WEBPACK_IMPORTED_MODULE_25__["reducers"], { metaReducers: _store__WEBPACK_IMPORTED_MODULE_25__["metaReducers"] }),
                _ngrx_effects__WEBPACK_IMPORTED_MODULE_31__["EffectsModule"].forRoot([_store_effects__WEBPACK_IMPORTED_MODULE_26__["RestClientEffects"]]),
                _ngrx_store_devtools__WEBPACK_IMPORTED_MODULE_30__["StoreDevtoolsModule"].instrument({
                    maxAge: 25,
                    logOnly: src_environments_environment__WEBPACK_IMPORTED_MODULE_35__["environment"].production,
                })
            ],
            providers: [_services_requests_service__WEBPACK_IMPORTED_MODULE_27__["RequestsService"], _services_environment_service__WEBPACK_IMPORTED_MODULE_28__["EnvironmentService"], src_app_shared_services__WEBPACK_IMPORTED_MODULE_29__["DialogService"], _services_run_request_service__WEBPACK_IMPORTED_MODULE_42__["RunRequestService"]],
            entryComponents: [_components_curl_form_curl_form_component__WEBPACK_IMPORTED_MODULE_37__["CurlFormComponent"], _components_save_request_save_request_component__WEBPACK_IMPORTED_MODULE_40__["SaveRequestComponent"]]
        })
    ], RestClientModule);
...
/* harmony import */ var src_app_shared_app_variables__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/app-variables */ "./src/app/shared/app-variables.ts");
/* harmony import */ var p_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! p-utils */ "./node_modules/p-utils/dist/p-utils.esm.js");
...
var RestInterpreter = /** @class */ (function () {
    function RestInterpreter() {
        ...
        this.interpreter.assignGlobalContext({ P: p_utils__WEBPACK_IMPORTED_MODULE_6__ });
    }
...
var RestClientEffects = /** @class */ (function () {
    function RestClientEffects(actions$, requestsService, router, notificationService) {
            ...
            return _this.requestsService.saveRequest$(payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (id) {
                ...
                switch (link.linkType) {
                    case _models__WEBPACK_IMPORTED_MODULE_11__["LinkType"].RestRequest:
                        ...
                        break;
                    case _models__WEBPACK_IMPORTED_MODULE_11__["LinkType"].PScriptEditor:
                        _this.router.navigate(['/rest-client/pscript-editor', link.ownerName, link.name]);
                        break;
        ...
        this.deselectRequest = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_actions_index__WEBPACK_IMPORTED_MODULE_9__["SavedRequestsActionTypes"].DESELECT_REQUEST), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (_a) {
            ...
            else if (_this.router.url.includes('/rest-client/pscript-editor')) {
                _this.router.navigate(['/rest-client/pscript-editor']);
            }
