...
/* harmony import */ var src_app_shared_interpreter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/shared/interpreter */ "./src/app/shared/interpreter.ts");
...
var DynamicPageComponent = /** @class */ (function () {
    ...
    DynamicPageComponent.prototype.ngOnInit = function () {
        ...
        this.page$.subscribe(function (pageInfo) {
            if (!pageInfo) {
                _this.router.navigate([owner, appName]);
            }
            else {
                _this.setPageInfo(pageInfo);
            }
        });
        this.headerCommands = [{
                label: 'Edit',
        ...
        this.interpreter = Object(src_app_shared_interpreter__WEBPACK_IMPORTED_MODULE_8__["getInterpreter"])();
    };
    DynamicPageComponent.prototype.editPage = function () {
        ...
        pageEditDialog.init.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function () { return pageEditDialog.component.save; })).subscribe(function (p) {
            ...
            _this.appService.savePageInfo(page, owner, appName).subscribe(function () {
                _this.setPageInfo(page);
            });
        });
    };
    DynamicPageComponent.prototype.setPageInfo = function (pageInfo) {
        var _this = this;
        this.pageInfo = null;
        setTimeout(function () {
...
/* harmony import */ var _ngx_dynamic_components_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ngx-dynamic-components/core */ "../ngx-dynamic-components/dist/@ngx-dynamic-components/core/fesm5/ngx-dynamic-components-core.js");
/* harmony import */ var _ngx_dynamic_components_bootstrap__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ngx-dynamic-components/bootstrap */ "../ngx-dynamic-components/dist/@ngx-dynamic-components/bootstrap/fesm5/ngx-dynamic-components-bootstrap.js");
/* harmony import */ var _ngx_dynamic_components_material__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ngx-dynamic-components/material */ "../ngx-dynamic-components/dist/@ngx-dynamic-components/material/fesm5/ngx-dynamic-components-material.js");
...
/* harmony import */ var src_app_shared_interpreter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/interpreter */ "./src/app/shared/interpreter.ts");
...
var ActionsService = /** @class */ (function () {
    ...
    ActionsService.prototype.addAppServices = function () {
        ...
        Object(src_app_shared_interpreter__WEBPACK_IMPORTED_MODULE_9__["registerFunction"])('showPage', function (pageName) {
            _this.showPage(_this.appService.currentApp, pageName);
        });
    ...
    ActionsService.prototype.addHttpActions = function () {
        ...
        Object(src_app_shared_interpreter__WEBPACK_IMPORTED_MODULE_9__["registerFunction"])('getSqlData', function (objectOwner, objectName, selectBody) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var e_3;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.sqlDbService.selectSqlObjectData('sql-shared', objectOwner, objectName, selectBody).toPromise()];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        e_3 = _a.sent();
                        return [2 /*return*/, e_3];
